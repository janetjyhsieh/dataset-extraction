"""Extract usage information from a paper PDF using an LLM.

Usage:
    python -m dataset_extraction.usage.extract path/to/paper.pdf
    python -m dataset_extraction.usage.extract path/to/paper.pdf --provider openai
    python -m dataset_extraction.usage.extract path/to/paper.pdf --provider claude --model claude-sonnet-4-6
"""
